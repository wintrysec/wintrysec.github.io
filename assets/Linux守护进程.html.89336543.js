import{_ as l}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as d,c as a,a as n,b as i,d as r,e,r as t}from"./app.04d5a320.js";const v="/assets/linux_deamon.e9f095c4.png",c={},o=e(`<h2 id="守护进程概述" tabindex="-1"><a class="header-anchor" href="#守护进程概述" aria-hidden="true">#</a> 守护进程概述</h2><p>守护进程（daemon）就是一直在后台运行的进程,一般是为了保护我们的程序/服务的正常运行，当程序被关闭、异常退出等时再次启动程序/恢复服务。</p><p>有时候需要让程序在后台不间断的运行可以这样做</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">nohup</span> ./api <span class="token operator">&amp;</span>
