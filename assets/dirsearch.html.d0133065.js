import{_ as i}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as t,c as p,a as s,b as n,d as l,e as a,r}from"./app.d54d0fba.js";const c={},o=a(`<div class="custom-container tip"><p class="custom-container-title">提示</p><p>因为dirsearch需要3.7或更高版本的python，所以需要先解决环境问题</p><p>Windows直接下载高版本的python安装即可，Centos7参考以下方法</p></div><h2 id="源码安装python" tabindex="-1"><a class="header-anchor" href="#源码安装python" aria-hidden="true">#</a> 源码安装python</h2><h4 id="一、安装开发者工具编译器和依赖" tabindex="-1"><a class="header-anchor" href="#一、安装开发者工具编译器和依赖" aria-hidden="true">#</a> 一、安装开发者工具编译器和依赖</h4><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>yum <span class="token parameter variable">-y</span> groupinstall <span class="token string">&quot;Development tools&quot;</span>
