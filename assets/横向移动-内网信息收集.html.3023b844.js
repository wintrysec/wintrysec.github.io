...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>3、查看mstsc对内和对外连接记录</p>`,20),p={href:"https://github.com/Heart-Sky/ListRDPConnections",target:"_blank",rel:"noopener noreferrer"},v=s(`<p>可能发现跨段的连接，还能定位运维人员主机</p><p>4、浏览器浏览记录</p><p>查看浏览器中访问过的内网应用</p><p>二次开发相关工具-深入研究实现原理</p><h3 id="被动主机发现-不扫描" tabindex="-1"><a class="header-anchor" href="#被动主机发现-不扫描" aria-hidden="true">#</a> 被动主机发现-不扫描</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment">#查看路由表</span>
