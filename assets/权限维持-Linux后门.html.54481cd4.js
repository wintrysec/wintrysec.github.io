import{_ as e}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as i,c as l,a as s,b as t,d as c,e as n,r as o}from"./app.ed2888ea.js";const r={},d=n(`<h2 id="ssh软连接后门" tabindex="-1"><a class="header-anchor" href="#ssh软连接后门" aria-hidden="true">#</a> SSH软连接后门</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment">#建立sshd的软连接</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></details>`,3);function m(v,b){const a=o("ExternalLinkIcon");return i(),l("div",null,[d,s("p",null,[s("a",p,[t("https://github.com/f0rb1dd3n/Reptile"),c(a)])]),u])}const f=e(r,[["render",m],["__file","权限维持-Linux后门.html.vue"]]);export{f as default};
