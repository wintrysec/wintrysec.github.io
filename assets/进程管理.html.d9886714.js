import{_ as o}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as r,c as m,d as c,w as e,e as u,a as n,b as s,r as d}from"./app.02b19a3e.js";const p={},b=u('<h2 id="进程状态" tabindex="-1"><a class="header-anchor" href="#进程状态" aria-hidden="true">#</a> 进程状态</h2><p><strong>Linux上进程有5种状态:</strong></p><div class="custom-container tip"><p class="custom-container-title">提示</p><ul><li><strong>R 运行 runnable</strong> (正在运行或在运行队列中等待)</li><li><strong>S 中断 sleeping</strong> (休眠中, 受阻, 在等待某个条件的形成或接受到信号)</li><li><strong>D 不可中断</strong> (收到信号不唤醒和不可运行, 进程必须等待直到有中断发生)</li><li><strong>Z 僵死</strong> (进程已终止, 但进程描述符存在, 直到父进程调用wait4()系统调用后释放)</li><li><strong>T 停止</strong> (进程收到SIGSTOP, SIGSTP, SIGTIN, SIGTOU信号后停止运行运行)</li></ul></div><h2 id="查看进程列表" tabindex="-1"><a class="header-anchor" href="#查看进程列表" aria-hidden="true">#</a> 查看进程列表</h2>',4),v=n("div",{class:"language-bash line-numbers-mode","data-ext":"sh"},[n("pre",{class:"language-bash"},[n("code",null,[n("span",{class:"token function"},"ps"),s(` aux
